...
class EmployeeController extends Controller
{
    ...
    public function deleteFile($employeeId)
    {
        ...
        if ($employee->encrypted_filename) {
            ...
            return redirect()->route('employees.show', $employeeId)->with('success', 'CV berhasil dihapus.');
        }

        return redirect()->route('employees.show', $employeeId)->with('error', 'CV tidak ditemukan.');
    }
